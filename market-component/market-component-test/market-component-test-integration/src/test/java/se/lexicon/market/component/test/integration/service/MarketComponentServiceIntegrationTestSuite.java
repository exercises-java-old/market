...
import org.junit.FixMethodMarket;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        MarketComponentServiceIntegrationTest.class
})
@FixMethodMarket(MethodSorters.NAME_ASCENDING)
public class MarketComponentServiceIntegrationTestSuite {
