...
public class PlaceMarketOrderEvent extends IdEntity<String> {
    ...
    public static class Builder extends AbstractEntityBuilder<PlaceMarketOrderEvent> {
        ...
        public PlaceMarketOrderEvent.Builder withSsn(String ssn) {
            this.ssn = ssn;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withAmount(BigDecimal amount) {
            this.amount = amount;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withInsertionTimestamp(Instant insertionTimestamp) {
            this.insertionTimestamp = insertionTimestamp;
            return this;
        }
        ...
        public PlaceMarketOrderEvent.Builder withNoOfItems(Integer noOfItems) {
            this.noOfItems = noOfItems;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withMinMaxValue(Money minMaxValue) {
            this.minMaxValue = minMaxValue;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withSide(Side side) {
            this.side = side;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withMarketPriceType(MarketPriceType marketPriceType) {
            this.marketPriceType = marketPriceType;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withOrderBookId(String orderBookId) {
            this.orderBookId = orderBookId;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withNoOfItemsToMatch(Integer noOfItemsToMatch) {
            this.noOfItemsToMatch = noOfItemsToMatch;
            return this;
        }

        public PlaceMarketOrderEvent.Builder withAllItemsMatched(Boolean allItemsMatched) {
            this.allItemsMatched = allItemsMatched;
            return this;
        }
